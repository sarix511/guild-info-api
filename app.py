...
async def create_jwt(region):
    ...
    # 👇 NEW PK ACCOUNT
    "PK": "uid=4735954681&password=743369AEAA7C634764B538645BEBCD707E36C0548F875A4D6A3A67FBAF3B5CF7"
        }
...
def get_clan_info():
    ...
    "PK": ("https://clientbp.ggblueshark.com/GetClanInfoByClanID", "clientbp.ggblueshark.com"),  # added
...
def health_check():
    regions_status = {}
    for region in ["IND", "BD", "BR", "US", "SAC", "NA", "PK"]:
